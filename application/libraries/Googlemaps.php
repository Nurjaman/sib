...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDbGgR7Bl-IlAcTeobZwk8fEk0u6sQRkW0'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "1.428407,111.4084333";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
