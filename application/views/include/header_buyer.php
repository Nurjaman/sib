        ...
        <div class="main-sidebar sidebar-style-2">
          <aside id="sidebar-wrapper">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="<?php echo active_link_method('order', 'reklame') ?>">
                <a href="<?php echo base_url('reklame/order') ?>" class="nav-link  "><i class="fas fa-database"></i><span>Data Pemesanan</span></a>
              </li>
              <li class="<?php echo active_link_method('perusahaan', 'reklame') ?>">
                <a href="<?php echo base_url('reklame/perusahaan') ?>" class="nav-link  "><i class="fas fa-database"></i><span>Data Perusahaan</span></a>
              </li>
